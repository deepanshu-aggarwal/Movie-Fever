...
function Favorites() {
  ...
  // for getting genres -> to build blue/gray buttons
  useEffect(() => {
  ...
  filteredMovies = curGenre == "All Genres" ? favorites : 
  ...
  return <>
    ...
    <div className="text-center">
      ...
      <input type="number" placeholder="Rows" value={rows} onchange={(e) => setRows(e.target.value)} className="border border-2 text-center p-1 m-2" />
    </div>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  >
                    <div className='flex'>
                      <img src="https://img.icons8.com/fluency-systems-regular/24/000000/circled-chevron-up.png" className='mr-2 cursor-pointer' 
                            onClick={() => {
                            setPopularity(0) 
                            setRating(-1)
                            }}/>
                      Rating
                      <img src="https://img.icons8.com/fluency-systems-regular/24/000000/circled-chevron-down.png" className='ml-2 mr-2 cursor-pointer'
                            onClick={() => {
                            setPopularity(0) 
                            setRating(1)
                            }}/>
